...
export default function ResumePreview({
  ...
  return (
    <div className={`p-6 rounded-lg shadow ${themeClass}`}>
      ...
      <div className="p-8 font-sans">
        ...
        <div className="text-center mb-6">
          ...
          <div className="flex flex-wrap justify-center gap-x-4 text-sm mt-1">
            ...
            {resumeData.contact?.phoneNumber && (
              <span>{resumeData.contact.phoneNumber}</span>
            )}
        ...
        {resumeData.workExperience &&
          ...
          resumeData.workExperience[0].title && (
            <div className="mb-6">
              <h2 className="text-lg font-bold border-b pb-1 mb-2">
                Work Experience
              </h2>
              {resumeData.workExperience.map((job, index) => (
                <div key={index} className="mb-4">
                  ...
                  {job.achievements &&
                    job.achievements.filter((a) => a).length > 0 && (
